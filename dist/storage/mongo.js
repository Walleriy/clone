...
var url = 'mongodb+srv://dbUser:Oeq6epFvyMC1ziIq@cluster0.xet16.mongodb.net/Market?retryWrites=true&w=majority';
var dbName = 'Market';
...
var getCollection = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getMongoInstance()];
            case 1:
                db = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                collection = _a.sent();
                id = item.id;
                return [4 /*yield*/, collection.replaceOne({ id: id }, item)];
            case 2:
                response = _a.sent();
                return [2 /*return*/, response.ops[0]];
        }
